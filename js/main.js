...
function evaluateAnswer(userAnswer,correctAnswer,possiblePoints){
  ...
  let confirmAnswer = confirm(`For ${possiblePoints}, you answered "${userAnswer}", and the correct answer is "${correctAnswer}". Your answer was ${checkAnswer}. Click OK to accept or click Cancel if the answer was not properly evaluated.`)
